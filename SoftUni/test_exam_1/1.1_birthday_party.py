...
# Напишете програма, с която да помогнете на Людмила да изчисли какъв бюджет ще ѝ бъде необходим, като имате
...
rent: float = float(input())
cake: float = (rent / 100) * 20
drinks: float = cake - ((cake / 100) * 45)
animator: float = rent / 3
budget: float = rent + cake + drinks + animator
print(f"{budget:.1f}")
